...
namespace MicroWrath
{
    ...
    internal static class MicroMod
    {
        ...
        private static bool LoadMod(ModEntry modEntry)
        {
            ...
            try
            {
                modEntry.Logger.Log($"Loading mod from {assPath}{Environment.NewLine}{FileVersionInfo.GetVersionInfo(assPath)}");

#if DEBUG
                modEntry.Logger.Log($"File Info:{Environment.NewLine}{FileVersionInfo.GetVersionInfo(assPath)}");
#endif
